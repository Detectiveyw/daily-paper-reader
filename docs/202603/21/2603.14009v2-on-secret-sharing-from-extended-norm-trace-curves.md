...
authors: Olav Geil
date: 2026-03-14
pdf: "https://arxiv.org/pdf/2603.14009v2"
tags: ["query:fss-llm"]
score: 6.0
evidence: 渐进式秘密共享方案与代数几何代码
tldr: 本研究探讨了基于扩展范数迹曲线的渐变秘密共享方案。通过分析单点代数几何码的高阶相对广义海明重量，论文证明了该方案不仅具有优异的参数性能，还具备双层安全性。此外，研究还澄清了前人提出的“类足迹方法”与通用代数几何码处理方法之间的关系，指出前者实际上是增强型Goppa界的巧妙应用，而非竞争性方法。
selection_source: fresh_fetch
motivation: 旨在探索扩展范数迹曲线在渐变秘密共享方案中的应用潜力及其高阶相对权重的性能表现。
method: 通过分析单点代数几何码的相对广义海明重量，并对比评估了不同的编码权重估计技术。
result: 证明了该方案在具备良好参数的同时拥有第二层安全保障，并揭示了现有估计方法与增强型Goppa界之间的内在联系。
conclusion: 扩展范数迹曲线是构建高性能秘密共享方案的有效工具，且其分析方法可统一于现有的代数几何码理论框架。
---
