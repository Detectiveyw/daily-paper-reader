...
date: 2026-03-09
pdf: "https://arxiv.org/pdf/2603.08879v1"
tags: ["query:ppml"]
score: 7.0
evidence: 机器学习中敏感数据的匿名化基准
tldr: 针对医疗数据隐私保护导致的数据获取难题，本研究推出了MultiGraSCCo，一个包含10种语言的多语言匿名化基准测试集。该研究利用神经机器翻译技术，将包含个人身份信息（PII）标注的数据翻译并进行文化适配，确保了标注的准确性与语境的合理性。该基准包含超过2500个标注，为匿名化系统的开发、验证及跨机构协作提供了重要资源。
selection_source: fresh_fetch
motivation: 隐私法规限制了真实患者数据的共享，导致开发和测试匿名化系统所需的高质量标注数据严重匮乏。
method: 采用神经机器翻译方法将标注数据扩展至十种语言，并在翻译过程中对人名和地名进行文化与语境适配，同时保留原始标注。
result: 经医学专业人士评估，该基准在翻译质量及个人信息的适配性方面均表现优异，共包含超过2500个个人信息标注。
conclusion: MultiGraSCCo为多语言匿名化研究提供了宝贵的开源资源，有助于提升自动个人信息检测系统的性能并促进安全的医疗数据共享。
---
