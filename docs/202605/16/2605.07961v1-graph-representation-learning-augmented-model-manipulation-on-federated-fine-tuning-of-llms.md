...
motivation: 联邦微调（FFT）面临恶意参与者通过操纵模型更新来破坏全局模型性能的安全威胁。
method: 提出AugMP策略，利用图表示学习捕捉良性更新特征，并采用增广拉格朗日对偶算法生成兼具破坏性和隐蔽性的恶意更新。
result: "实验显示AugMP使全局模型准确率下降高达26%，且能有效绕过基于距离和相似性的传统防御手段。"
conclusion: 本研究揭示了FFT在面对高级模型操纵攻击时的脆弱性，强调了开发更鲁棒的联邦学习防御机制的必要性。
---
